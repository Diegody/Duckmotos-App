...
public class PHPController {
    ...
    RequestQueue requestQueue;
     ...
     public static String IP = "192.168.1.12"; //IP Casa
    //public static String IP = "172.17.4.28"; //IP Universidad

    //Usuario URLS
    private static String URLREGISTER = "http://" + IP + "/duckmotosws/usuarios/register.php";
    private static String URLLOGIN = "http://" + IP + "/duckmotosws/usuarios/login.php?";
    private static String URLREADALLUSER = "http://" + IP + "/duckmotosws/usuarios/readAll.php";
    private static String URLEDITUSER = "http://" + IP + "/duckmotosws/usuarios/update.php";
    private static String URLDELETEUSER = "http://" + IP + "/duckmotosws/usuarios/delete.php";

    //Perfil URL
    private static String ULRCREATEPERFIL = "http://" + IP + "/duckmotosws/perfiles/create.php";
    private static String URLREADALLPERFIL = "http://" + IP + "/duckmotosws/perfiles/readAll.php";
    private static String URLEDITPERFIL = "http://" + IP + "/duckmotosws/perfiles/update.php";
    private static String URLDELETEPERFIL = "http://" + IP + "/duckmotosws/perfiles/delete.php";

    //Comentarios URL
    private static String ULRCREATECOMENTARIO = "http://" + IP + "/duckmotosws/comentarios/create.php";
    private static String URLREADALLCOMENTARIO = "http://" + IP + "/duckmotosws/comentarios/readAll.php";
    private static String URLEDITCOMENTARIO = "http://" + IP + "/duckmotosws/comentarios/update.php";
    private static String URLDELETECOMENTARIO = "http://" + IP + "/duckmotosws/comentarios/delete.php";

    //Publicaciones URL
    private static String ULRCREATEPUBLICACIONES = "http://" + IP + "/duckmotosws/publicaciones/create.php";
    private static String URLREADALLPUBLICACIONES = "http://" + IP + "/duckmotosws/publicaciones/readAll.php";
    private static String URLEDITPUBLICACIONES = "http://" + IP + "/duckmotosws/publicaciones/update.php";
    private static String URLDELETEPUBLICACIONES = "http://" + IP + "/duckmotosws/publicaciones/delete.php";

    //Imagenes URL
    private static String ULRCREATEIMAGENES = "http://" + IP + "/duckmotosws/imagenes/create.php";
    private static String URLREADALLIMAGENES = "http://" + IP + "/duckmotosws/imagenes/readAll.php";
    private static String URLEDITIMAGENES = "http://" + IP + "/duckmotosws/imagenes/update.php";
    private static String URLDELETEIMAGENES = "http://" + IP + "/duckmotosws/imagenes/delete.php";
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(c, "Usuario Creado con Éxito", Toast.LENGTH_SHORT).show();
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(c, "Error al Crear Usuario", Toast.LENGTH_SHORT).show();
                        System.out.println("----------------------------");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        Toast.makeText(c, "Sesión Iniciada", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(c, "Error, Datos No validos", Toast.LENGTH_SHORT).show();
                        System.out.println("----------------------------");
                        System.out.println("ERROR: " + error.getMessage());
                        System.out.println("----------------------------");
                    }
